/**
 * Integration Test Runner (JavaScript)
 * 
...
async function runAllIntegrationTests() {
  ...
  try {
    const { runCommunityFunctionalityIntegrationTests } = require('./communityFunctionality.integration.test');
  ...
  try {
    const { runGroupManagementIntegrationTests } = require('./groupManagement.integration.test');
 ...
 */
async function generateDetailedReport(testSuites, totalDuration, overallPassed) {
  try {
