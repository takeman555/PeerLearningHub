...
console.log('🚀 Announcements Table Creation Guide');
console.log('=====================================\n');

console.log('❌ The announcements table does not exist in your Supabase database.');
...
console.log('\n5. ▶️  Click "Run" to execute the SQL\n');

console.log('6. ✅ After successful execution, restart your app:\n');
console.log('   npm start\n');

console.log('7. 🧪 Test the announcements functionality:\n');
console.log('   - Navigate to Resources tab');
console.log('   - Switch to "お知らせ" tab');
...
console.log('🔧 Need help? Check the migration file at:');
