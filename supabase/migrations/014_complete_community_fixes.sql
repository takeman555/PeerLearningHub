-- Complete Community Fixes Migration
-- This migration adds all missing columns and fixes relationships
...
DROP POLICY IF EXISTS "Community members can view display settings" ON profiles;
DROP POLICY IF EXISTS "Users can update their own community settings" ON profiles;
